...
class block_readabilityscore_external extends external_api
{
    ...
    public static function process_text($selectedtext)
    {
        global $USER, $DB;

        // Parameter validation
        $params = self::validate_parameters(self::process_text_parameters(), array('selectedtext' => $selectedtext));
        ...
        store_readability_score($USER->id, $readabilityscore);
